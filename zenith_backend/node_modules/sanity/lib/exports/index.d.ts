...
export declare const CollapseMenuButton: React_2.ForwardRefExoticComponent<
  Pick<
    CollapseMenuButtonProps & Omit<React_2.HTMLProps<HTMLButtonElement>, 'as'>,
    | 'key'
    | 'cite'
    | 'data'
    | 'form'
...
/** @internal */
export declare const ColorSchemeContext: React_2.Context<{
...
/** @internal */
export declare function createObservableController(
...
export declare const DiffCard: React_2.ForwardRefExoticComponent<
  Pick<
    DiffCardProps & Omit<React_2.HTMLProps<HTMLElement>, 'height' | 'as'>,
    | 'key'
    | 'cite'
    | 'data'
    | 'form'
 ...
 * @internal
 */
export declare function getExpandOperations(state: ObjectFormNode, path: Path): ExpandOperation[]
...
/** @internal */
export declare const listenQuery: (
  client: SanityClient,
  query:
    | string
    | {
 ...
 * @internal
 */
export declare function matchWorkspace<TWorkspace extends WorkspaceLike>({
  pathname,
  workspaces,
}: MatchWorkspaceOptions<TWorkspace>): MatchWorkspaceResult<TWorkspace>

/** @internal */
export declare interface MatchWorkspaceOptions<TWorkspace extends WorkspaceLike> {
  workspaces: TWorkspace[]
  pathname: string
}

/** @internal */
export declare type MatchWorkspaceResult<TWorkspace extends WorkspaceLike> =
  | {
      type: 'match'
...
/** @internal */
export declare function ObjectInputMember(props: ObjectInputMemberProps): JSX.Element | null
...
/** @internal */
export declare type OperationEventsListener = (
  idPair: IdPair,
  typeName?: string
) => Observable<OperationSuccess | OperationError>
...
export declare const PreviewCard: React_2.ForwardRefExoticComponent<
  Pick<
    CardProps & Omit<React_2.HTMLProps<HTMLDivElement>, 'height'>,
    | 'key'
    | 'cite'
    | 'data'
    | 'form'
...
export declare const ScrollContainer: React_2.ForwardRefExoticComponent<
  Pick<
    ScrollContainerProps<React_2.ElementType<any>>,
    | 'key'
    | 'cite'
    | 'data'
    | 'form'
 ...
 * @internal
 */
export declare function SearchDialog({onClose, onOpen, open}: SearchDialogProps): JSX.Element | null
...
export declare const ToolLink: React_2.ForwardRefExoticComponent<
  Pick<
    ToolLinkProps & Omit<React_2.HTMLProps<HTMLAnchorElement>, 'name' | 'href'>,
    | 'key'
    | 'cite'
    | 'data'
    | 'form'
