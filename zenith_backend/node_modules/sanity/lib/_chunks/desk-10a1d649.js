...
function getDocumentExistence(documentId, _ref2) {
  ...
  return versionedClient.observable.request(requestOptions).pipe(operators.map(_ref3 => {
    let {
      omitted
    } = _ref3;
...
const useInternalReferences = sanity.createHookFromObservableFactory(_ref4 => {
...
const useCrossDatasetReferences = sanity.createHookFromObservableFactory(_ref5 => {
...
const ReferenceChildLink = React.forwardRef(function ReferenceChildLink2(_ref6, ref) {
  let {
    documentId,
    documentType,
    parentRefPath,
...
const ChevronWrapper = styled__default.default(ui.Box)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  margin-left: auto;\n"])));
const CrossDatasetReferencesDetails = styled__default.default.details(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  flex: none;\n\n  &[open] ", " {\n    transform: rotate(180deg);\n  }\n"])), ChevronWrapper);
const CrossDatasetReferencesSummary = styled__default.default.summary(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  list-style: none;\n\n  &::-webkit-details-marker {\n    display: none;\n  }\n"])));
const TableContainer = styled__default.default(ui.Box).attrs({
  paddingX: 2,
  paddingBottom: 2
})(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  overflow: auto;\n  max-height: 150px;\n"])));
const Table = styled__default.default.table(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  width: 100%;\n  text-align: left;\n  padding: 0 ", ";\n  border-collapse: collapse;\n\n  th {\n    padding: ", ";\n  }\n\n  thead > tr {\n    position: sticky;\n    top: 0;\n    background: var(--card-bg-color);\n    z-index: 1;\n  }\n\n  td {\n    padding: 0 ", ";\n  }\n\n  tr > *:last-child {\n    text-align: right;\n  }\n"])), _ref7 => {
  let {
    theme
  } = _ref7;
...
const DocumentIdFlex = styled__default.default(ui.Flex)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  min-height: 35px;\n"])));
const ReferencesCard = styled__default.default(ui.Card).attrs({
  radius: 2,
  shadow: 1,
  marginBottom: 4,
  flex: "auto"
...
function ConfirmDeleteDialogBody(_ref10) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    ...
    }), /* @__PURE__ */jsxRuntime.jsx(ReferencesCard, {
      children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
        direction: "column",
        height: "fill",
        children: [internalReferences.totalCount > 0 && /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
          ...
          }), /* @__PURE__ */jsxRuntime.jsxs(TableContainer, {
...
const DialogBody = styled__default.default(ui.Flex).attrs({
  padding: 4,
  direction: "column",
  height: "fill"
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.MenuButton, {
    ...
    menu: /* @__PURE__ */jsxRuntime.jsx(ui.Menu, {
      ...
      jsxRuntime.jsxs(React.Fragment, {
        children: [groupIndex > 0 && /* @__PURE__ */jsxRuntime.jsx(ui.MenuDivider, {}), group.title && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
          paddingX: 3,
          paddingTop: 3,
          paddingBottom: 2,
          children: /* @__PURE__ */jsxRuntime.jsx(ui.Label, {
        ...
        }), group.items.map((item, itemIndex) => /* @__PURE__ */jsxRuntime.jsx(PaneContextMenuItem, {
          item,
          onAction
...
function PaneContextMenuItem(props) {
  ...
  const IntentButtonOrActionButton = React.forwardRef((linkProps, linkRef) => item.intent ? /* @__PURE__ */jsxRuntime.jsx(router$1.IntentLink, {
    ...linkProps,
...
const Root$5 = styled__default.default(ui.Layer)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  position: relative;\n  width: 1px;\n  min-width: 1px;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    bottom: 0;\n    width: 1px;\n    background-color: var(--card-border-color);\n  }\n\n  &:not([data-disabled]) {\n    cursor: ew-resize;\n    width: 9px;\n    min-width: 9px;\n    margin: 0 -4px;\n\n    &:before {\n      left: 4px;\n    }\n\n    &:after {\n      content: '';\n      display: block;\n      position: absolute;\n      top: 0;\n      left: 0;\n      width: 9px;\n      bottom: 0;\n      background-color: var(--card-border-color);\n      opacity: 0;\n      transition: opacity 150ms;\n    }\n\n    &[data-dragging]:after,\n    &:hover:after {\n      opacity: 0.2;\n    }\n  }\n"])));
...
const Root$4 = styled__default.default(ui.Card)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  outline: none;\n\n  // NOTE: This will render a border to the right side of each pane\n  // without taking up physical space.\n  box-shadow: 1px 0 0 var(--card-border-color);\n"])));
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(PaneContext.Provider, {
        value: contextValue,
        children: /* @__PURE__ */jsxRuntime.jsxs(Root$4, {
          "data-testid": "pane",
          tone: "inherit",
          hidden,
          id,
...
const Root$3 = styled__default.default(ui.Card)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  position: relative;\n  outline: none;\n"])));
...
const Root$2 = styled__default.default(ui.Layer)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  position: sticky;\n  bottom: 0;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    left: 0;\n    right: 0;\n    top: -1px;\n    border-bottom: 1px solid var(--card-shadow-outline-color);\n  }\n"])));
const RootCard = styled__default.default(ui.Card)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  padding-bottom: env(safe-area-inset-bottom);\n"])));
const PaneFooter = React.forwardRef(function PaneFooter2(props, ref) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
    zOffset: "paneFooter",
    children: /* @__PURE__ */jsxRuntime.jsx(Root$2, {
...
const Root$1 = styled__default.default(ui.Layer)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  line-height: 0;\n  position: sticky;\n  top: 0;\n\n  &:not([data-collapsed]):after {\n    content: '';\n    display: block;\n    position: absolute;\n    left: 0;\n    right: 0;\n    bottom: -1px;\n    border-bottom: 1px solid var(--card-shadow-outline-color);\n  }\n"])));
const Layout = styled__default.default(ui.Flex)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  transform-origin: calc(51px / 2);\n\n  [data-collapsed] > div > & {\n    transform: rotate(90deg);\n  }\n"])));
const TitleBox = styled__default.default(ui.Box)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral([""])));
const TitleTextSkeleton = styled__default.default(ui.TextSkeleton)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  width: 66%;\n  max-width: 175px;\n"])));
const TitleText = styled__default.default(ui.Text)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  cursor: default;\n  outline: none;\n"])));
const TABS_SCROLL_PADDING = 100;
const TabsBox = styled__default.default(ui.Box)(_ref14 => {
  let {
    theme
  } = _ref14;
  const {
...
const PaneHeader = React.forwardRef(function PaneHeader2(props, ref) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.LayerProvider, {
    zOffset: 100,
    children: /* @__PURE__ */jsxRuntime.jsx(Root$1, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
        ...
        children: /* @__PURE__ */jsxRuntime.jsxs(ui.Card, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsxs(Layout, {
            ...
            sizing: "border",
            style: layoutStyle,
            children: [backButton, /* @__PURE__ */jsxRuntime.jsxs(TitleBox, {
              flex: 1,
            ...
            }), actions && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
              hidden: collapsed,
              paddingLeft: 1,
              children: /* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
                zOffset: "paneHeader",
          ...
          }), (tabs || subActions) && /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
            align: "center",
            hidden: collapsed,
            paddingTop: 1,
            paddingRight: 2,
            ...
            }), subActions && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
              children: subActions
            })]
          })]
        })
...
const Root = styled__default.default(ui.Card)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  transition: opacity 200ms;\n  position: relative;\n  z-index: 1;\n  padding-left: env(safe-area-inset-left);\n  padding-right: env(safe-area-inset-right);\n  opacity: 0;\n\n  &:not([hidden]) {\n    display: flex;\n  }\n\n  &:not([data-collapsed]) {\n    overflow: auto;\n  }\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n\n  &[data-resizing] {\n    pointer-events: none;\n  }\n"])));
...
const PaneHeaderActions = React.memo(_ref19 => {
  let {
  ...
  const [actionMenuItems, contextMenuItems] = React.useMemo(() => {
    const nonCreateMenuItem = menuItems.filter(item => {
      var _a;
      return ((_a = item.intent) == null ? void 0 : _a.type) !== "create";
    });
    return partition__default.default(nonCreateMenuItem, item => item.showAsAction);
  }, [menuItems]);
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Inline, {
    space: 1,
    children: [Boolean(combinedInitialValueTemplates.length) && /* @__PURE__ */jsxRuntime.jsx(PaneHeaderCreateButton, {
    ...
    ...actionMenuItems.map((actionItem, actionIndex) => {
      return /* @__PURE__ */jsxRuntime.jsx(ui.Tooltip, {
        ...
        placement: "bottom",
        children: actionItem.intent ? /* @__PURE__ */jsxRuntime.jsx(IntentButton, {
          intent: actionItem.intent,
          "aria-label": actionItem.title,
          icon: actionItem.icon || icons.UnknownIcon,
          mode: "bleed"
        }) : /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
          "aria-label": actionItem.title,
          icon: actionItem.icon || icons.UnknownIcon,
    ...
    //
    Boolean(contextMenuItems.length) && /* @__PURE__ */jsxRuntime.jsx(PaneContextMenuButton, {
...
const DiscardChangesAction = _ref22 => {
  let {
    id,
    type,
    published,
...
const DuplicateAction = _ref23 => {
  ...
  const router = router$1.useRouter();
...
const HistoryRestoreAction = _ref24 => {
  let {
    id,
    type,
    revision,
...
const deskTool = sanity.definePlugin(options => ({
  ...
  tools: [{
    ...
    component: React.lazy(() => Promise.resolve().then(function () {
      return require('./index-b8972157.js');
    }).then(function (n) {
      return n.index;
    })),
...
class ComponentBuilder {
  ...
  title(title) {
    return this.clone({
      title,
      id: this.spec.id || camelCase__default.default(title)
    });
  }
  getTitle() {
    return this.spec.title;
...
const createDocumentChildResolver = _ref27 => {
  let {
    resolveDocumentNode
  } = _ref27;
...
const defaultIntentChecker = (intentName, params, _ref30) => {
  let {
    pane
  } = _ref30;
  var _a, _b;
...
const shallowIntentChecker = (intentName, params, _ref31) => {
  let {
    pane,
    index
  } = _ref31;
...
const resolveTypeForDocument = async (getClient, id) => {
...
exports.DeskToolContext = DeskToolContext;
...
//# sourceMappingURL=desk-10a1d649.js.map
