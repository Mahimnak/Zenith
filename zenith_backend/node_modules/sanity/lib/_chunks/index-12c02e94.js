...
import { Flex, Container, Stack, Heading, Text, Box, Button, Spinner, VirtualList, Card } from '@sanity/ui';
import shallowEquals from 'shallow-equals';
import { SyncIcon, ArrowLeftIcon } from '@sanity/icons';
import 'sanity/router';
import { usePaneLayout, usePane, PaneContent, PaneHeader, BackLink, PaneHeaderActions, Pane, _DEBUG } from './desk-257f76bb.js';
import { Delay, useDeskTool, useDeskToolSetting } from './index-9e58f0f1.js';
import * as PathUtils from '@sanity/util/paths';
import { isKeySegment, isIndexSegment, isReferenceSchemaType } from '@sanity/types';
import { getPublishedId, collate, useSchema, listenQuery, useClient, DEFAULT_STUDIO_CLIENT_OPTIONS, useSource, useUnique, SourceProvider } from 'sanity';
import { PaneItem } from './PaneItem-baaea00f.js';
import 'lodash/omit.js';
import 'lodash/isNumber.js';
import 'lodash/isString.js';
import 'react-rx';
import { Subject, merge, of, concat, fromEvent } from 'rxjs';
import { map, distinctUntilChanged, publishReplay, refCount, switchMap, share, delay, takeUntil, startWith, catchError, take, mergeMapTo, scan, filter } from 'rxjs/operators';
...
function DocumentListPaneContent(props) {
  ...
  const content = useMemo(() => {
        ...
        children: /* @__PURE__ */jsx(Container, {
          ...
          children: /* @__PURE__ */jsxs(Stack, {
            ...
            children: [/* @__PURE__ */jsx(Heading, {
              ...
              as: "p",
              children: ["Error: ", /* @__PURE__ */jsx("code", {
                children: error.message
              })]
            }), onRetry && /* @__PURE__ */jsx(Box, {
    ...
    return /* @__PURE__ */jsxs(Box, {
      padding: 2,
      children: [items.length > 0 && /* @__PURE__ */jsx(VirtualList, {
        gap: 1,
        getItemKey: getDocumentKey,
        items,
        renderItem,
        onChange: onListChange
      }, "".concat(index, "-").concat(collapsed)), isLoading && /* @__PURE__ */jsx(Card, {
        borderTop: true,
        marginTop: 1,
        paddingX: 3,
        paddingY: 4,
      ...
      }), hasMoreItems && /* @__PURE__ */jsx(Card, {
        marginTop: 1,
        paddingX: 3,
        paddingY: 4,
        radius: 2,
...
const DocumentListPaneHeader = memo(_ref => {
  let {
    index,
...
const getQueryResults = function (receivedProps$) {
  ...
  const queryProps$ = receivedProps$.pipe(map(props => ({
    ...
    query: props.query,
    params: props.params
  })), distinctUntilChanged(deepCompare), publishReplay(1), refCount());
...
function useDocumentList(opts) {
  ...
  const handleListChange = useCallback(_ref3 => {
    let {
      toIndex
    } = _ref3;
...
const DocumentListPane = memo(function DocumentListPane2(props) {
  const {
    childItemId,
    index,
    isActive,
  ...
  return /* @__PURE__ */jsx(SourceProvider, {
    ...
    children: /* @__PURE__ */jsxs(Pane, {
      ...
      minWidth: 320,
      selected: isSelected,
      children: [_DEBUG, /* @__PURE__ */jsx(DocumentListPaneHeader, {
        index,
        initialValueTemplates,
        menuItems,
        menuItemGroups,
        ...
        setSortOrder,
        title
      }), /* @__PURE__ */jsx(DocumentListPaneContent, {
        childItemId,
        error,
        filterIsSimpleTypeContraint,
        fullList,
...
export { DocumentListPane as default };
//# sourceMappingURL=index-12c02e94.js.map
