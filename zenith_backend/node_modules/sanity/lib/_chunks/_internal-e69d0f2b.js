...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-e2339fa0.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-0b86d345.js');
    });
...
const followProgress = (jobId, client, output) => {
  ...
  const listenUrl = client.getUrl("jobs/".concat(jobId, "/listen"));
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-f1664c8a.js');
  });
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await Promise.resolve().then(function () {
    return require('./previewAction-15099e9a.js');
  });
  return mod.default;
}
...
const execCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./execScript-e9f1c7dc.js');
    });
    return mod.default(args, context);
  }
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-a80b6100.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$4
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-49268967.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deleteApiAction-c9517852.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$2
...
exports.debug = debug;
//# sourceMappingURL=_internal-e69d0f2b.js.map
