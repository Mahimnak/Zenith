...
import { useElementRect, Card, Flex, Spinner, Box, Text, Container, Heading, Stack, Label, Code, Button, _raf2, useToast, AvatarStack, MenuItem, rem, Tooltip, Menu, Popover, useClickOutside, useGlobalKeyDown, BoundaryElementProvider, TextInput, Dialog, TabList, Tab, TabPanel, MenuButton, Inline, usePortal, PortalProvider, useLayer, Grid, Hotkeys, LayerProvider, Badge, DialogProvider, useMediaIndex, ErrorBoundary } from '@sanity/ui';
import { ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, PANE_DEFAULT_MIN_WIDTH, PANE_COLLAPSED_WIDTH, PaneLayoutContext, Root as Root$6, DeskToolContext, LOADING_PANE, SerializeError, Pane, PaneHeader, PaneContent, useDocumentPane, usePaneRouter, DocumentPaneContext, usePane, DocTitle, PaneContextMenuButton, usePaneLayout, HistoryRestoreAction, PaneFooter, setActivePanes, DeskToolProvider } from './desk-257f76bb.js';
...
import { GetHookCollectionState, isRecord, useDocumentStore, useUnique, isDev, useDocumentOperationEvent, useSource, useClient, DEFAULT_STUDIO_CLIENT_OPTIONS, useSchema, useTemplates, useHistoryStore, usePresenceStore, getPublishedId, useInitialValue, useDocumentOperation, useEditState, useValidationStatus, useConnectionState, toMutationPatches, setAtPath, getDraftId, useDocumentValuePermissions, useFormState, getExpandOperations, UserAvatar, useTimeAgo, visitDiff, ScrollContainer, ChangeFieldWrapper, DiffTooltip, NoChanges, DocumentChangeContext, ChangeList, useSettingsStore, isString, useDocumentPreviewStore, useCurrentUser, useDocumentPresence, createPatchChannel, PresenceOverlay, FormBuilder, fromMutationPatches, ValidationList, unstable_useValuePreview, LegacyLayerProvider, useSyncState, ChangeConnectorRoot, SourceProvider, useDocumentType, useTemplatePermissions, ReferenceInputOptionsProvider, useZIndex, _isCustomDocumentTypeDefinition, useWorkspace } from 'sanity';
import { generateHelpUrl } from '@sanity/generate-help-url';
import isEqual from 'lodash/isEqual.js';
import { useRouter, useRouterState } from 'sanity/router';
import { uuid } from '@sanity/uuid';
import styled, { css, keyframes } from 'styled-components';
import { SyncIcon, RestoreIcon, BinaryDocumentIcon, EarthAmericasIcon, AddCircleIcon, TrashIcon, CloseIcon, EditIcon, PublishIcon, UnpublishIcon, SelectIcon, SearchIcon, WarningOutlineIcon, ReadOnlyIcon, ErrorOutlineIcon, InfoOutlineIcon, ArrowLeftIcon, SplitVerticalIcon, ChevronDownIcon, PlayIcon } from '@sanity/icons';
...
const paneMap = {
  component: lazy(() => import('./index-cb44a2b3.js')),
  document: lazy(() => import('./index-d647773e.js')),
  documentList: lazy(() => import('./index-12c02e94.js')),
  list: lazy(() => import('./index-a25d89f9.js'))
};
...
const DocumentPaneProvider = memo(props => {
  ...
  const displayed = useMemo(() => viewOlderVersion ? historyController.displayed() || {
    _id: value._id,
    _type: value._type
  } : value,
  ...
  const liveEdit = useMemo(() => Boolean(schemaType == null ? void 0 : schemaType.liveEdit), [documentType, schema]);
...
const IconWrapper = styled(Flex)(_ref18 => {
  let {
    theme
  } = _ref18;
  var _a;
...
const Root$5 = styled(MenuItem)(_ref19 => {
  let {
    state = "enabled",
    isHovered,
    theme
  ...
  return css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n    position: relative;\n    min-width: 244px;\n\n    ", "\n\n    ", "\n\n      ", "\n\n    // line styling \uD83D\uDC47\n      &:first-child ", "::before {\n      height: 50%;\n      top: unset;\n      bottom: 0;\n    }\n\n    &:last-child ", "::before {\n      height: 50%;\n    }\n\n    ", "\n\n    // Remove timeline lines when using the keyboard to navigate timeline items\n    &:focus ", "::before {\n      background: transparent;\n    }\n  "])), state === "selected" && css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n      --card-bg-color: ", ";\n      --card-fg-color: ", ";\n      --card-muted-fg-color: ", ";\n      --card-border-color: ", ";\n      &:not([data-selection-bottom='true']) {\n        border-top-left-radius: 0;\n        border-top-right-radius: 0;\n      }\n    "])), selectedState.bg, selectedState.fg, selectedState.muted, selectedState.bg), state === "withinSelection" && css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n      border-bottom-left-radius: 0;\n      border-bottom-right-radius: 0;\n      box-shadow: 0px 3px 0px 0px var(--card-bg-color);\n      &:not([data-selection-top='true']) {\n        border-radius: 0;\n      }\n\n      ", " {\n        &::before {\n          background: var(--card-hairline-soft-color);\n        }\n      }\n    "])), IconWrapper), state === "disabled" && css(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n      [data-ui='Avatar'] {\n        opacity: 0.2;\n      }\n    "]))), IconWrapper, IconWrapper, (isHovered || state === "selected") && css(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n      ", "::before {\n        background: transparent;\n      }\n    "])), IconWrapper), IconWrapper);
});
const IconBox = styled(Box)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  background: var(--card-bg-color);\n  border-radius: 50px;\n  position: relative;\n  z-index: 2;\n"])));
const EventLabel = styled(Text)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  text-transform: capitalize;\n"])));
const TimestampBox = styled(Box)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  min-width: 1rem;\n  margin-left: ", ";\n"])), _ref20 => {
  let {
    theme
  } = _ref20;
...
const Root$4 = styled(Box)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  overflow: auto;\n  -webkit-overflow-scrolling: touch;\n"])));
const StackWrapper = styled(Stack)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  max-width: 200px;\n"])));
const MenuWrapper = styled(Menu)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  overflow: auto;\n  box-sizing: border-box;\n  max-height: calc(100vh - 198px);\n"])));
...
const Timeline = _ref21 => {
  ...
  return /* @__PURE__ */jsxs(Root$4, {
    ...
    "data-ui": "timeline",
    children: [timeline.chunkCount === 0 && /* @__PURE__ */jsxs(StackWrapper, {
      padding: 3,
      space: 3,
      children: [/* @__PURE__ */jsx(Text, {
        size: 1,
    ...
    }), timeline.chunkCount > 0 && /* @__PURE__ */jsx(MenuWrapper, {
      ref: listRef,
      padding: 1,
      space: 0,
      children: timeline.mapChunks(chunk => {
        ...
        const item = /* @__PURE__ */jsx(TimelineItem, {
          chunk,
          isSelectionBottom,
          isSelectionTop,
          state,
    ...
    }), !timeline.reachedEarliestEntry && /* @__PURE__ */jsx(Flex, {
      align: "center",
      justify: "center",
      padding: 4,
...
const Root$3 = styled(Popover)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  & > div {\n    display: flex;\n    flex-direction: column;\n\n    & > [data-ui='Card'] {\n      flex: 1;\n      min-height: 0;\n      display: flex;\n      flex-direction: column;\n\n      /* This is the scrollable container rendered by <Timeline /> */\n      & > div {\n        flex: 1;\n        min-height: 0;\n      }\n    }\n  }\n"])));
function TimelineMenu(_ref22) {
  ...
  const content = open && /* @__PURE__ */jsx("div", {
    ref: setMenuContent,
  ...
  const revLabel = chunk ? "".concat(upperFirst(formatTimelineEventLabel(chunk.type)), " ").concat(timeAgo) : "Current version";
...
const Scroller$1 = styled(ScrollContainer)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  height: 100%;\n  overflow: auto;\n  position: relative;\n  scroll-behavior: smooth;\n"])));
...
const JSONInspectorWrapper = styled.div(_ref25 => {
  let {
    theme
  } = _ref25;
  const {
...
const Root$2 = styled(Card)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
const TextOneLine = styled(Text)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  & > * {\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n"])));
...
const Root$1 = styled(Card)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
...
const DocumentPanelHeader = memo(forwardRef((_ref28, ref) => {
  let {
    rootElement
  } = _ref28;
  const {
...
const Scroller = styled(ScrollContainer)(_ref29 => {
  let {
    $disabled
  } = _ref29;
  if ($disabled) {
  ...
  return /* @__PURE__ */jsxs(Flex, {
    ...
    children: [/* @__PURE__ */jsx(DocumentPanelHeader, {
      ...
      children: /* @__PURE__ */jsx(PortalProvider, {
        ...
        children: /* @__PURE__ */jsxs(BoundaryElementProvider, {
...
const Root = styled(Flex)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  cursor: default;\n"])));
...
const StyledMotionPath = styled(motion.path)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  transform-origin: center;\n"])));
...
const rotateAnimation = keyframes(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  0% {\n    transform: rotate(0);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
const RotateGroup = styled.g(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  transform-origin: center;\n\n  &[data-rotate] {\n    animation: ", " 1s ease-in-out infinite;\n  }\n"])), rotateAnimation);
const root = {
  syncing: {
    scale: 1,
    transition: {
...
const DocumentActionsBox = styled(Box)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  min-width: 10em;\n  max-width: 16em;\n"])));
...
"absolute"];
const StyledChangeConnectorRoot = styled(ChangeConnectorRoot)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: flex;\n  min-height: 0;\n  min-width: 0;\n"])));
...
const StyledPaneLayout = styled(PaneLayout)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  min-height: 100%;\n  min-width: 320px;\n"])));
const isSaveHotkey = isHotkey("mod+s");
const DeskTool = memo(function DeskTool2(_ref35) {
  let {
    onPaneChange
  } = _ref35;
  var _a;
  ...
  return /* @__PURE__ */jsxs(PortalProvider, {
    ...
    children: [/* @__PURE__ */jsx(StyledPaneLayout, {
      flex: 1,
      height: layoutCollapsed ? void 0 : "fill",
      minWidth: 512,
  ...
  return /* @__PURE__ */jsx(ErrorBoundary, {
    ...
    children: /* @__PURE__ */jsx(SourceProvider, {
      ...
      children: /* @__PURE__ */jsx(DeskToolProvider, {
        defaultDocumentNode,
        structure,
        children: intent ? /* @__PURE__ */jsx(IntentResolver, {
          ...intent
        }) : /* @__PURE__ */jsx(DeskTool, {
...
//# sourceMappingURL=index-9e58f0f1.js.map
