...
const TitleBox = styled(Box)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral([""])));
...
const TabsBox = styled(Box)(_ref14 => {
  let {
    theme
  } = _ref14;
  const {
      ...
      children: /* @__PURE__ */jsx(LegacyLayerProvider, {
        ...
        children: /* @__PURE__ */jsxs(Card, {
          ...
          children: [/* @__PURE__ */jsxs(Layout, {
            ...
            sizing: "border",
            style: layoutStyle,
            children: [backButton, /* @__PURE__ */jsxs(TitleBox, {
              flex: 1,
...
const PaneHeaderActions = memo(_ref19 => {
  let {
...
const deskTool = definePlugin(options => ({
  ...
  tools: [{
    ...
    component: lazy(() => import('./index-9e58f0f1.js').then(function (n) {
      return n.index;
    })),
...
//# sourceMappingURL=desk-257f76bb.js.map
