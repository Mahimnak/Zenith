...
async function getBuildAction() {
  const mod = await import('./buildAction-6c45b6e5.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-1181ac4a.js');
...
const undeployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./undeployAction-aef05d6a.js');
    return mod.default(args, context);
  },
  helpText: helpText$m
};
...
async function getDevAction() {
  const mod = await import('./devAction-ec97da49.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-c380806f.js');
  return mod.default;
}
...
const execCommand = {
  ...
  helpText: helpText$8,
  action: async (args, context) => {
    const mod = await import('./execScript-9e7ea734.js');
    return mod.default(args, context);
  }
};
const corsGroup = {
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-2020ab9e.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-04445810.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deleteApiAction-bcedf7dd.js');
    return mod.default(args, context);
  },
  helpText: helpText$2
};
...
export { cliProjectCommands, debug };
//# sourceMappingURL=_internal-efd30ddf.js.map
