...
var _internal = require('./_internal-e69d0f2b.js');
...
var getGraphQLAPIs = require('./getGraphQLAPIs-0c5e1d64.js');
...
function pluralizeTypeName(name) {
  ...
  const plural = pluralize__default.default(last.toLowerCase());
...
async function getCurrentSchemaProps(client, dataset, tag) {
  try {
    const apiUrl = client.getUrl("/apis/graphql/".concat(dataset, "/").concat(tag));
...
//# sourceMappingURL=deployApiAction-49268967.js.map
